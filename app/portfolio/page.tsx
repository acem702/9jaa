      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 pb-32">
        ...
        <div className="mb-6 md:mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl md:text-4xl font-black text-slate-900">Portfolio</h1>
          </div>
          <p className="text-sm md:text-lg text-slate-600 font-medium">Track your prediction performance and manage your positions</p>
        </div>
